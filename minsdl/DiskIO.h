...
public:
    ...
    bool read(ATAController *controller, int drive, uint8_t *buf, uint32_t lba) override;
    bool write(ATAController *controller, int drive, const uint8_t *buf, uint32_t lba) override;
